...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define ISR_PRIORITY_GPT12_TIMER    5                       /* Define the GPT12 Timer3 interrupt priority            */
...
void initGpt12Timer(void)
{
    ...
    //IfxGpt12_T2_setReloadInputMode(&MODULE_GPT120, );                       /* Set T2 to timer mode         */
    IfxGpt12_T2_setTimerValue(&MODULE_GPT120, RELOAD_VALUE_10ms);                        /* Set T2 start value           */
...
void interruptGpt12(void)
{
    ...
    waitTime(IfxStm_getTicksFromMilliseconds(BSP_DEFAULT_TIMER, 100));      // 1msec 지연 루틴
    IfxPort_setPinLow(TEST_PIN3);
}
...
{
    IfxGpt12_T2_setTimerValue(&MODULE_GPT120, RELOAD_VALUE_10ms);                        /* Set T3 start value        */
